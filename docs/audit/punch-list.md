...
| 9 | Rate-limit hardening — sliding window Redis, ProxyHeader, memory cleanup stop chan | 3 should-fix | low | 3h | ✅ shipped [#26](https://github.com/14mdzk/goscratch/pull/26) |
